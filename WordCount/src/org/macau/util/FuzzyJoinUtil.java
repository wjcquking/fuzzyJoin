...
public class FuzzyJoinUtil {
	 ...
	 * @param in
	 * 			the record
	 * @return string which clean the punctuation and extra spaces
	 * 
	 */
	 ...
	 */
	public static String getData(Object[] splits, int[] dataColumns,
			char tokenSeparator) {
		String data = null;
	...
	public static int[] getDataColumns(String columnsString) {
		String[] splits = columnsString
				.split(FuzzyJoinConfig.RECORD_DATA_VALUE_SEPARATOR_REGEX); // ","
