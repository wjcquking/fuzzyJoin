...
public class FuzzyJoinConfig {
    ...
    // similarity
    //
    public static final String SIMILARITY_NAME_PROPERTY = NAMESPACE
            + ".similarity.name";
    public static final String SIMILARITY_NAME_VALUE = "Jaccard";
    public static final String SIMILARITY_THRESHOLD_PROPERTY = NAMESPACE
            + ".similarity.threshold";
    public static final float SIMILARITY_THRESHOLD_VALUE = .8f;
    //
    // record
    //
    public static final String RECORD_DATA_PROPERTY = NAMESPACE
            + ".record.data";
    public static final String RECORD_DATA_VALUE = "1";
    public static final String RECORD_DATA1_PROPERTY = NAMESPACE
            + ".record.data1";
    public static final String RECORD_DATA1_VALUE = "1";
    //
    // data
    //    
    public static final String DATA_TOKENS_PROPERTY = NAMESPACE
            + ".data.tokens";
    //
    // const
    //
