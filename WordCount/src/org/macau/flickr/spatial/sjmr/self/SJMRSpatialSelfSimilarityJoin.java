...
public class SJMRSpatialSelfSimilarityJoin {
...
public static boolean SJMRSpatialJoin(Configuration conf) throws Exception{
		...
		spaitialJob.setJarByClass(SJMRSpatialSelfSimilarityJoin.class);
		
		spaitialJob.setMapperClass(SJMRSpatialSelfMapper.class);
		//there can add one combiner which can combine the result
		//spaitialJob.setCombinerClass(TemporalBasicReducer.class);
		
		spaitialJob.setReducerClass(SJMRSpatialSelfReducer.class);
